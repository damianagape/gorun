...
variable "cluster_version" { # gcloud container get-server-config --project="gogcp-main-7" --region="europe-central2" --flatten="channels" --filter="channels.channel=STABLE" --format="value(channels.defaultVersion)"
  type    = string
  default = null
}
