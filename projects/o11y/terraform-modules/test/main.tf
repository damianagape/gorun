...
module "test_lgtm_stack" {
  source = "../../terraform-submodules/gke-lgtm-stack" # "gcs::https://www.googleapis.com/storage/v1/gogcp-main-3-private-terraform-modules/gorun/o11y/gke-lgtm-stack/0.5.100.zip"

  google_project           = data.google_project.this
  google_container_cluster = data.google_container_cluster.this

  grafana_domain = "grafana.gogke-test-3.damianagape.pl"
  grafana_email  = "grafana@gogke-test-3.damianagape.pl"
}

module "test_otel_collectors" {
  source = "../../terraform-submodules/k8s-otel-collectors" # "gcs::https://www.googleapis.com/storage/v1/gogcp-main-3-private-terraform-modules/gorun/o11y/k8s-otel-collectors/0.5.100.zip"
  depends_on = [
...
module "test_prom_exporters" {
  source = "../../terraform-submodules/k8s-prom-exporters" # "gcs::https://www.googleapis.com/storage/v1/gogcp-main-3-private-terraform-modules/gorun/o11y/k8s-prom-exporters/0.5.100.zip"

  blackbox_exporter_urls = [
    "https://grafana.gogke-test-3.damianagape.pl/healthz",
    "https://stateful-kuard.gogke-test-3.damianagape.pl/healthy",
    "https://stateless-kuard.gogke-test-3.damianagape.pl/healthy",
  ]
}
