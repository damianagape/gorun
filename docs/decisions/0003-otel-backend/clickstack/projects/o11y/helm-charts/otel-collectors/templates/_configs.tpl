...
exporters:
  ...
  #
  #
  # prometheusremotewrite/prometheus: # https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/exporter/prometheusremotewriteexporter/README.md
  #   endpoint: http://127.0.0.1:9090/api/v1/push
  #
  # debug/logs:
  #   verbosity: detailed
  #
